...
#[derive(Debug)]
pub struct ArduinoNexusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ArduinoNexusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ArduinoNexus processing");
    
    let mut processor = ArduinoNexusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ArduinoNexusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ArduinoNexusProcessor::new(false);
